...
The following example clones the "[Serial flash read write](https://github.com/Infineon/mtb-example-psoc-edge-serial-flash-readwrite)" application with the desired name "SerialFlashReadWrite" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-serial-flash-readwrite --user-app-name SerialFlashReadWrite --target-dir "C:/mtb_projects"
   ```
